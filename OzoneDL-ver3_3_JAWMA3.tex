...
\end{center}
%
Fig \ref{fig:ANNmodels} shows that each layer can have different numbers of nodes, however, the number of nodes in the DNN hidden layers are usually kept the same for each layer. 
...
Fig 14. Training error associated with feature reduction on network prediction.\\
Fig 15. Prediction horizons using 5 features and default parameters. \\
Fig 16. Impact of a. batch samples, b. look back nodes, and c.\\
